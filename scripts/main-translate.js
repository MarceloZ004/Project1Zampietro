document.addEventListener('DOMContentLoaded', () => {
    ...
    function updateLanguage(language) {
      const translations = {
        en: {
          projectTitle: 'Project 1, Marcelo Zampietro',
          projectDescription: 'Use the navigation above to browse through the different pages.',
        ...
        es: {
          projectTitle: 'Proyecto 1, Marcelo Zampietro',
          projectDescription: 'Utiliza la navegación de arriba para explorar las diferentes páginas.',
          navHomepage: 'Inicio',
          navPersona1: 'Persona 1',
          navPersona2: 'Persona 2',
